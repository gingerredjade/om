  ...
  <div class="page-container">
    ...
    <div class="toolbar">
      <div class="">
        <el-form :inline="true" :model="filters" :size="size" ref="filters">
          ...
          <el-form-item>
            <b-s-button icon="fa fa-undo" :tag="$t('ACTION.RESET')" variant=""
        ...
        <el-table :data="tableTreeData" stripe size="mini" style="width: 100%;"
          ...
          <el-table-column
            ...
            <template slot-scope="scope">
              <b-s-button icon="fa fa-edit" :tag="$t('ACTION.EDIT')" perms="sys:dept:edit"
                          @click="handleEdit(scope.$index, scope.row)"
                          stylesheet="font-size: 1.0rem;"
              />
              <b-s-button icon="fa fa-trash" :tag="$t('ACTION.DELETE')" perms="sys:dept:delete" variant="danger"
    ...
    <el-dialog :title="operation ? $t('ACTION.ADD') : $t('ACTION.EDIT')" width="40%"
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button :size="size"  type="primary" @click="submitForm()" style="color: #fff;">{{$t('ACTION.SUBMIT')}}</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
<script>
  ...
  import TableTreeColumn from '@/view/components/TableTreeColumn';
