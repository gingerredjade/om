    ...
    <div class="main-box">
      <ul class="clearfix">
        ...
        <li>
          ...
          <div class="box-all" style="height: 30%;">
          ...
          <div class="box-all" style="height: 20%;">
            <router-link to="/log/query">
              <div class="box-title">系统运行状态</div>
            </router-link>
            <div class="box-info" id="system-run-status-chart" style="width: 100%; height: 85%;">
              <div id="system-run-status-con"
                   class=""
                   style="width: 100%; height: 85%;"
                   v-bind:class="isSysRunHealth===true?'status-health':'status-abnormal'"
              >
                {{ sysRunInfo }}
              </div>
...
<script>
  ...
  export default {
    ...
    beforeDestroy() {
      ...
      // 临时测试
      if (this.srsTimer) {
        clearInterval(this.currentSysRunStatus());
        this.nowTime = true;
      }
    },
    data() {
    ...
    methods: {
      ...
      currentSysRunStatus: function () {
        let _this = this;
        this.srsTimer = setInterval(() => {
          _this.isSysRunHealth = false;
          setTimeout(function(){
            _this.isSysRunHealth = true;
          }, 3000);
        }, 2000);
...
<style scoped>
  ...
  *{
  ...
  .status-health {
    color: #4cc134; /**/
    /*margin: 10px;*/
    animation: healthchangeshadow 1.5s ease-in infinite ;
    /* 其它浏览器兼容性前缀 */
    -webkit-animation: healthchangeshadow 1.5s linear infinite;
    -moz-animation: healthchangeshadow 1.5s linear infinite;
    -ms-animation: healthchangeshadow 1.5s linear infinite;
    -o-animation: healthchangeshadow 1.5s linear infinite;
  }
  @keyframes healthchangeshadow {
    0%{ text-shadow: 0 0 4px #4cc134}
    50%{ text-shadow: 0 0 40px #4cc134}
    100%{ text-shadow: 0 0 4px #4cc134}
  }
  /* 添加兼容性前缀 */
  @-webkit-keyframes healthchangeshadow {
    0%{ text-shadow: 0 0 4px #4cc134}
    50%{ text-shadow: 0 0 40px #4cc134}
    100%{ text-shadow: 0 0 4px #4cc134}
  }
  @-moz-keyframes healthchangeshadow {
    0%{ text-shadow: 0 0 4px #4cc134}
    50%{ text-shadow: 0 0 40px #4cc134}
    100%{ text-shadow: 0 0 4px #4cc134}
  }
  @-ms-keyframes healthchangeshadow {
    0%{ text-shadow: 0 0 4px #4cc134}
    50%{ text-shadow: 0 0 40px #4cc134}
    100%{ text-shadow: 0 0 4px #4cc134}
  }
  @-o-keyframes healthchangeshadow {
    0%{ text-shadow: 0 0 4px #4cc134}
    50%{ text-shadow: 0 0 40px #4cc134}
    100%{ text-shadow: 0 0 4px #4cc134}
  }
  .status-abnormal {
    color: #F0052E;
    animation: abnormalchangeshadow 1.5s ease-in infinite ;
    /* 其它浏览器兼容性前缀 */
    -webkit-animation: abnormalchangeshadow 1.5s linear infinite;
    -moz-animation: abnormalchangeshadow 1.5s linear infinite;
    -ms-animation: abnormalchangeshadow 1.5s linear infinite;
    -o-animation: abnormalchangeshadow 1.5s linear infinite;
  }
  @keyframes abnormalchangeshadow {
    0%{ text-shadow: 0 0 4px #F0052E}
    50%{ text-shadow: 0 0 40px #F0052E}
    100%{ text-shadow: 0 0 4px #F0052E}
  }
  /* 添加兼容性前缀 */
  @-webkit-keyframes abnormalchangeshadow {
    0%{ text-shadow: 0 0 4px #F0052E}
    50%{ text-shadow: 0 0 40px #F0052E}
    100%{ text-shadow: 0 0 4px #F0052E}
  }
  @-moz-keyframes abnormalchangeshadow {
    0%{ text-shadow: 0 0 4px #F0052E}
    50%{ text-shadow: 0 0 40px #F0052E}
    100%{ text-shadow: 0 0 4px #F0052E}
  }
  @-ms-keyframes abnormalchangeshadow {
    0%{ text-shadow: 0 0 4px #F0052E}
    50%{ text-shadow: 0 0 40px #F0052E}
    100%{ text-shadow: 0 0 4px #F0052E}
  }
  @-o-keyframes abnormalchangeshadow {
    0%{ text-shadow: 0 0 4px #F0052E}
    50%{ text-shadow: 0 0 40px #F0052E}
    100%{ text-shadow: 0 0 4px #F0052E}
  }
