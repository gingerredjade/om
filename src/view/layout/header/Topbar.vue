<template>
  ...
  <div class="topbar">
    ...
    <!--begin: Quick panel toggle Layout Settings -->
    ...
    <!--<div class="topbar-item">
      <button class="btn btn-icon btn-hover-transparent-white aside-toggle ml-n3 mr-1"
              id="kt_aside_desktop_toggle"
              ref="kt_aside_desktop_toggle" @click="onAsideToggle">
