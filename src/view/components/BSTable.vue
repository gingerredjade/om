<template>
  <div>
    ...
    <el-table :data="data.list" :highlight-current-row="highlightCurrentRow" @selection-change="selectionChange"
      ...
      <el-table-column type="selection" width="50" v-if="showBatchDelete & showOperation" header-align="center" align="center">
      </el-table-column>
      ...
      <el-table-column :label="$t('ACTION.OPERATION','ch')" width="185" v-if="showOperation" header-align="center" align="center">
        <template slot-scope="scope">
          <b-s-button icon="fa fa-edit" :tag="$t('ACTION.EDIT')" variant="" :size="sizeBs" :perms="permsEdit"
                      stylesheet="font-size: 1.0rem;"
                      @click="handleEdit(scope.$index, scope.row)">
          </b-s-button>
          <b-s-button icon="fa fa-trash" :tag="$t('ACTION.DELETE')" variant="danger" :size="sizeBs" :perms="permsDelete"
                      stylesheet="font-size: 1.0rem;" style="margin-left: 8px;"
    ...
    <div class="toolbar" style="padding:10px;">
      <b-s-button :tag="$t('ACTION.BATCHDELETE')" :perms="permsDelete" :size="sizeBs" variant="danger"
